...
then
    ...
    echo "Indexing keyword-kg-linkg on DBpedia 12/2022"
    ...
    echo "Indexing keyword-kg-linkg on DBpedia 03/2022"
    ...
    echo "Indexing keyword-kg-linkg on DBpedia 10/2016"
    ...
    echo "Indexing keyword-kg-linkg on DBpedia 2014"
    ...
    echo "Indexing keyword-kg-linkg on Wikidata"
