...
for TABLE in ${BENCHMARK_DIR}/semtab/HardTables/tables/* ;\
do
...
for TABLE in ${BENCHMARK_DIR}/semtab/tfood/horizontal/test/tables/ ;\
do
...
for TABLE in ${BENCHMARK_DIR}/toughtables/wikidata/tables/ ;\
do
...
for TABLE in ${BENCHMARK_DIR}/wikitables_2013/tables/ ;\
do
...
for TABLE in ${BENCHMARK_DIR}/wikitables_2019/tables/ ;\
do
...
for TABLE in ${BENCHMARK_DIR}/toughtables/dbpedia/tables/ ;\
do
