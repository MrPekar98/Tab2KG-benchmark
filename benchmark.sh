...
sleep 2m
docker run --rm --network evaluation -e ENDPOINT=${IP} -v ${PWD}/benchmarks:/benchmarks -v ${PWD}/baselines/magic/:/hdt -v ${PWD}/results:/results magic_dbp-10-2016
...
sleep 2m
docker run --rm --network evaluation -e ENDPOINT=${IP} -v ${PWD}/benchmarks:/benchmarks -v ${PWD}/baselines/magic/:/hdt -v ${PWD}/results:/results magic_dbp-12-2022
docker stop kg-lookup-service

docker run --rm --network evaluation -e ENDPOINT=${IP} -v ${PWD}/benchmarks:/benchmarks -v ${PWD}/baselines/magic/:/hdt -v ${PWD}/results:/results magic_wd
