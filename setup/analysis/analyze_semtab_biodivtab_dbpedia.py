...
def analyze_semtab():
    ...
    plt.savefig('/plots/SemTab_BioDivTab_DBpedia.pdf')

    return stats

# Returns SemTab stats
def load_stats():
    with open('/plots/.SemTab_BioDivTab-DBP.stats', 'rb') as file:
...
if __name__ == '__main__':
    ...
    if sys.argv[1] == 'new':
        ...
        write_stats('/plots/.SemTab_BioDivTab-DBP.stats', stats_semtab)
