...
if __name__ == '__main__':
    ...
    plot(stats_tfood_horizontal.type_distribution(), 25, 12, 18, '/plots/SemTab_tFood_horizontal_Wikidata.pdf')

    print('SemTab (tFood entity - Wikidata) stats:')
    stats_tfood_entity.print()
    plot(stats_tfood_entity.type_distribution(), 25, 12, 18, '/plots/SemTab_tFood_entity_Wikidata.pdf')
