...
if __name__ == '__main__':
    ...
    plot(stats_wikitables_wikidata_2013.type_distribution(), 10, 14, 18, '/plots/Wikitables-Wikidata_2013.pdf')

    print('Wikitables 2019 stats (Wikidata):')
    stats_wikitables_wikidata_2019.print()
    plot(stats_wikitables_wikidata_2019.type_distribution(), 10, 14, 18, '/plots/Wikitables-Wikidata_2019.pdf')
